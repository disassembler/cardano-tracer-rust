//! High-level tracing integration for cardano-tracer
//!
//! This module provides integration with the Rust `tracing` ecosystem,
//! allowing applications to forward their traces to cardano-tracer.
...
/// Tracing layer that forwards traces to cardano-tracer
...
/// Helper to create a tracing subscriber with cardano-tracer forwarding
